  ...
  _getTranslations() {
    const translations = {
      ja: {
        ...
        decision_path: '現在の経路',
        decision_grid: 'グリッド方式',
        decision_grid_help: '空間をどう分割しますか？',
        decision_metric: 'メートルグリッド',
        decision_spatial: '空間ID',
        decision_metric_note: 'この分岐内でセルサイズと集約方法を設定します。',
        decision_spatial_note: 'ズームをautoまたはz15〜25から選択します。メートルサイズはautoの目標値です。',
        decision_time: '時間',
        decision_time_help: '単一時点または時系列？',
        decision_snapshot: '単一時点',
        decision_timeline: '時系列',
        decision_snapshot_note: '読み込んだ点を一度だけ描画します。再生操作は選択できません。',
        decision_timeline_note: '点とボクセルが同期する4時点を生成し、再生できます。',
        decision_values: '値のマッピング',
        decision_values_help: '連続色または明示的なクラス？',
        decision_gradient: 'グラデーション',
        decision_classes: 'クラス分類',
        decision_gradient_note: '従来の連続色を使います。クラス数と分類対象は選択できません。',
        decision_classes_note: '分類方式、クラス数、パレット、分類対象を選択できます。',
        decision_surface: 'ボクセル表現',
        decision_surface_help: '面または構造？',
        decision_solid: 'ソリッド',
        decision_wireframe: 'ワイヤーフレーム',
        decision_inset: 'インセット',
        decision_emulation: 'エミュレーション',
        decision_solid_note: '面を表示します。透明度とアウトラインも調整できます。',
        decision_wireframe_note: '枠線だけを表示します。面の透明度は選択できません。',
        decision_inset_note: '面と内側の枠線を表示し、距離と適用対象を設定します。',
        decision_emulation_note: '太線をエミュレーションし、適用範囲と描画方式を設定します。',
        decision_data: 'データ',
        decision_render: '描画',
        decision_tune: 'この経路を詳細調整',
      ...
      en: {
        ...
        decision_path: 'Current path',
        decision_grid: 'Grid system',
        decision_grid_help: 'How should space be divided?',
        decision_metric: 'Metric grid',
        decision_spatial: 'Spatial ID',
        decision_metric_note: 'Set cell sizing and aggregation inside this branch.',
        decision_spatial_note: 'Choose auto or z15–25. Metric size is the target used by auto.',
        decision_time: 'Time',
        decision_time_help: 'One state or a sequence?',
        decision_snapshot: 'Snapshot',
        decision_timeline: 'Timeline',
        decision_snapshot_note: 'Renders the loaded points once. Playback is unavailable.',
        decision_timeline_note: 'Creates four synchronized point and voxel slices with playback.',
        decision_values: 'Value mapping',
        decision_values_help: 'Continuous colors or explicit classes?',
        decision_gradient: 'Gradient',
        decision_classes: 'Classes',
        decision_gradient_note: 'Uses legacy continuous colors. Class count and classification targets are unavailable.',
        decision_classes_note: 'Choose a scheme, class count, palette, and classification targets.',
        decision_surface: 'Voxel surface',
        decision_surface_help: 'Fill or structure?',
        decision_solid: 'Solid',
        decision_wireframe: 'Wireframe',
        decision_inset: 'Inset',
        decision_emulation: 'Emulation',
        decision_solid_note: 'Filled voxels. Opacity and outlines remain available.',
        decision_wireframe_note: 'Outline-only voxels. Fill opacity controls are unavailable.',
        decision_inset_note: 'Show filled voxels with inset edges; set distance and target.',
        decision_emulation_note: 'Emulate thick frames; set scope and rendering mode.',
        decision_data: 'Data',
        decision_render: 'Render',
        decision_tune: 'Fine-tune this path',
