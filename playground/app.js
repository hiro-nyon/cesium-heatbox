  ...
  _getTranslations() {
    const translations = {
      ja: {
        ...
        decision_metric_note: '「3 · グリッド」でセルサイズを選択します。空間IDズームは選択できません。',
        decision_spatial_note: 'autoまたはz15〜25を選択します。メートルサイズはautoの目標値にだけ使われます。',
        decision_time: '時間',
      ...
      en: {
        ...
        decision_metric_note: 'Choose the cell size in Grid. Spatial ID zoom is unavailable.',
        decision_spatial_note: 'Choose auto or z15–25. Metric sizing is used only as the auto target.',
        decision_time: 'Time',
