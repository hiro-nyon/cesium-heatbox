...
> **Note**: 将来の予定・ロードマップは [ROADMAP.md](https://github.com/hiro-nyon/cesium-heatbox/blob/main/ROADMAP.md) および [GitHub Issues](https://github.com/hiro-nyon/cesium-heatbox/issues) で管理されています。
