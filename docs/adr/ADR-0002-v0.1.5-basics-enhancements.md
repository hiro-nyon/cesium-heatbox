...
**Implementation State**: Implemented — shipped in v0.1.5. `colorMap`, diverging colours, `highlightTopN`,
and `debug.showBounds` are present in `src/utils/constants.js` and the render path at v1.3.7.
