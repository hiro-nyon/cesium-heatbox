...
Accepted - 2025-08-25 (Planned-for: v0.1.6)

**Implementation State**: Implemented — shipped in v0.1.6, including the outline-width options and the
documentation/Wiki synchronisation pipeline (`tools/wiki-sync.js`).
