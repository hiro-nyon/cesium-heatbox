...
**Implementation State**: Implemented — `examples/` is organised into the intended categories
(`observability/`, `rendering/`, `outlines/`, `selection-limits/`, `data/`) plus later additions
(`aggregation/`, `spatial-id/`, `temporal/`).
