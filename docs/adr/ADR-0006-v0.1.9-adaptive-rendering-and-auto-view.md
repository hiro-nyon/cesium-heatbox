...
## Status
Accepted - 2025-08-30 (Introduced-in: v0.1.9)

**Implementation State**: Implemented — `autoVoxelSizeMode`, `autoVoxelTargetFill`, the device-tier render
budget (`src/utils/deviceTierDetector.js`), and `fitView` are all current. Note that camera-aware *render
planning* was added later and separately; see ADR-0020.
